...
var Recorder = function( config ){
	...
	this.config.encoderSampleRate = config.encoderSampleRate || 16000;
...
Recorder.prototype.initStream = function(){
	...
	function ( stream ) {
		...
		that.eventTarget.dispatchEvent( new Event( "streamReady" ) );//consoleole.log(1);
	},
	function ( e ) {
		//consoleole.log(1);
...
Recorder.prototype.resume = function() {
	if ( this.state === "paused" ) 
	{
		...
		var that = this;////consoleole.log(this.stream);
